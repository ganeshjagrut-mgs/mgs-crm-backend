...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTITYTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENTITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENTITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENTITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENTITYTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENTITYTYPE actions', async () => {
      const expectedActions = [
        {
