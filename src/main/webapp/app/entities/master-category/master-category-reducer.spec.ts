...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MASTERCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_MASTERCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MASTERCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MASTERCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MASTERCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MASTERCATEGORY actions', async () => {
      const expectedActions = [
        {
