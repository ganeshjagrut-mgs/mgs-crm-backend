...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMERCOMPANY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CUSTOMERCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMERCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMERCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMERCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMERCOMPANY actions', async () => {
      const expectedActions = [
        {
