...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './master-static-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MASTERSTATICTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MASTERSTATICTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MASTERSTATICTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MASTERSTATICTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MASTERSTATICTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MASTERSTATICTYPE actions', async () => {
      const expectedActions = [
        {
