            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="crmApp.lead.name">Name</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
                <th className="hand" onClick={sort('leadNumber')}>
                  <Translate contentKey="crmApp.lead.leadNumber">Lead Number</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('leadNumber')} />
                </th>
                ...
                <th>
                  <Translate contentKey="crmApp.lead.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="crmApp.lead.customer">Customer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="crmApp.lead.leadSource">Lead Source</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="crmApp.lead.industryType">Industry Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="crmApp.lead.leadStatus">Lead Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {leadList.map((lead, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{lead.user ? lead.user.id : ''}</td>
                  <td>{lead.customer ? <Link to={`/customer/${lead.customer.id}`}>{lead.customer.id}</Link> : ''}</td>
                  <td>{lead.leadSource ? <Link to={`/master-static-type/${lead.leadSource.id}`}>{lead.leadSource.id}</Link> : ''}</td>
                  <td>{lead.industryType ? <Link to={`/master-static-type/${lead.industryType.id}`}>{lead.industryType.id}</Link> : ''}</td>
                  <td>{lead.leadStatus ? <Link to={`/master-static-type/${lead.leadStatus.id}`}>{lead.leadStatus.id}</Link> : ''}</td>
