  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="crmApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="crmApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('crmApp.country.name')}
                id="country-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField label={translate('crmApp.country.code')} id="country-code" name="code" data-cy="code" type="text" />
              <ValidatedField
                label={translate('crmApp.country.createdAt')}
              ...
              />
              <ValidatedField
                label={translate('crmApp.country.createdBy')}
              ...
              />
              <ValidatedField
                label={translate('crmApp.country.updatedAt')}
              ...
              />
              <ValidatedField
                label={translate('crmApp.country.updatedBy')}
              ...
              />
              <ValidatedField
                label={translate('crmApp.country.active')}
                id="country-active"
                name="active"
                data-cy="active"
                check
