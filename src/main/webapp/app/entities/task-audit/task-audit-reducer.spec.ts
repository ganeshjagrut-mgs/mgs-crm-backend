...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TASKAUDIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TASKAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TASKAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TASKAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TASKAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TASKAUDIT actions', async () => {
      const expectedActions = [
        {
