  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="crmApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="crmApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('crmApp.department.name')}
                id="department-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField label={translate('crmApp.department.code')} id="department-code" name="code" data-cy="code" type="text" />
              <ValidatedField
                label={translate('crmApp.department.description')}
