...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PIPELINETAG_LIST actions', async () => {
    ...
    it('dispatches FETCH_PIPELINETAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PIPELINETAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PIPELINETAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PIPELINETAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PIPELINETAG actions', async () => {
      const expectedActions = [
        {
