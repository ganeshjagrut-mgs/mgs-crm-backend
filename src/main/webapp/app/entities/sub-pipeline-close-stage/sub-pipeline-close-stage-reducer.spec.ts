...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './sub-pipeline-close-stage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBPIPELINECLOSESTAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBPIPELINECLOSESTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBPIPELINECLOSESTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBPIPELINECLOSESTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBPIPELINECLOSESTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBPIPELINECLOSESTAGE actions', async () => {
      const expectedActions = [
        {
