...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pipeline.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PIPELINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PIPELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PIPELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PIPELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PIPELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PIPELINE actions', async () => {
      const expectedActions = [
        {
