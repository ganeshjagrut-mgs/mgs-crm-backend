...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENCRYPTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENCRYPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENCRYPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENCRYPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENCRYPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENCRYPTION actions', async () => {
      const expectedActions = [
        {
