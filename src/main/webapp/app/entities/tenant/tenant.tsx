  ...
  return (
    <div>
      <h2 id="tenant-heading" data-cy="TenantHeading">
        <Translate contentKey="crmApp.tenant.home.title">Tenants</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="crmApp.tenant.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/tenant/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="crmApp.tenant.home.createLabel">Create new Tenant</Translate>
          </Link>
        </div>
      </h2>
        ...
        {tenantList && tenantList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="crmApp.tenant.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('logo')}>
                  <Translate contentKey="crmApp.tenant.logo">Logo</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('logo')} />
                </th>
                ...
                <th className="hand" onClick={sort('subId')}>
                  <Translate contentKey="crmApp.tenant.subId">Sub Id</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('subId')} />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="crmApp.tenant.home.notFound">No Tenants found</Translate>
            </div>
          )
        )}
      </div>
