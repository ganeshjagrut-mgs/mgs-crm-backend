...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './master-static-group.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MASTERSTATICGROUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_MASTERSTATICGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MASTERSTATICGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MASTERSTATICGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MASTERSTATICGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MASTERSTATICGROUP actions', async () => {
      const expectedActions = [
        {
