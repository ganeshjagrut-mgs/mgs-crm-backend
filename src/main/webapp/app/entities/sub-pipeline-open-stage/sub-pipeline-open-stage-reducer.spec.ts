...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './sub-pipeline-open-stage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBPIPELINEOPENSTAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBPIPELINEOPENSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBPIPELINEOPENSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBPIPELINEOPENSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBPIPELINEOPENSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBPIPELINEOPENSTAGE actions', async () => {
      const expectedActions = [
        {
