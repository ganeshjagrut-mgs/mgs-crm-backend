...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBPIPELINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBPIPELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBPIPELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBPIPELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBPIPELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBPIPELINE actions', async () => {
      const expectedActions = [
        {
