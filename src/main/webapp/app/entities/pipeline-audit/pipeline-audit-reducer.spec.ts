...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PIPELINEAUDIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PIPELINEAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PIPELINEAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PIPELINEAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PIPELINEAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PIPELINEAUDIT actions', async () => {
      const expectedActions = [
        {
