 ...
 * @howToUse
 * ```
 *     <some-element *mtHasAnyAuthority="'ROLE_ADMIN'">...</some-element>
 *
 *     <some-element *mtHasAnyAuthority="['ROLE_ADMIN', 'ROLE_USER']">...</some-element>
 * ```
 */
@Directive({
  selector: '[mtHasAnyAuthority]',
})
export default class HasAnyAuthorityDirective {
  public authorities = input<string | string[]>([], { alias: 'mtHasAnyAuthority' });
