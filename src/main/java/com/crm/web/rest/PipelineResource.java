...
import com.crm.service.PipelineQueryService;
...
/**
 * REST controller for managing {@link com.crm.domain.Pipeline}.
 */
@RestController
...
public class PipelineResource {
    ...
    public ResponseEntity<PipelineDTO> updatePipeline(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, pipelineDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PipelineDTO> partialUpdatePipeline(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, pipelineDTO.getId().toString())
        );
    }
