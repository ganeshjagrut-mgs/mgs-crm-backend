 ...
 */
@Entity
@Table(name = "sub_pipeline_close_stage")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SubPipelineCloseStage implements Serializable {
    ...
    public SubPipelineCloseStage id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public SubPipelineCloseStage index(Integer index) {
        this.setIndex(index);
        return this;
    }
    ...
    public SubPipelineCloseStage stage(MasterStaticType masterStaticType) {
    ...
    public SubPipelineCloseStage subPipeline(SubPipeline subPipeline) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SubPipelineCloseStage)) {
            return false;
        }
        return getId() != null && getId().equals(((SubPipelineCloseStage) o).getId());
    }
