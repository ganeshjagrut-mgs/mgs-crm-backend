...
/**
 * Criteria class for the {@link com.crm.domain.Country} entity. This class is used
 * in {@link com.crm.web.rest.CountryResource} to receive all the possible filtering options from
...
public class CountryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, code, createdAt, createdBy, updatedAt, updatedBy, active, distinct);
    }
