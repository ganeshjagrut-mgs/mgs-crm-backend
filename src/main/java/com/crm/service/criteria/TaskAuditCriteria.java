...
/**
 * Criteria class for the {@link com.crm.domain.TaskAudit} entity. This class is used
 * in {@link com.crm.web.rest.TaskAuditResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /task-audits?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TaskAuditCriteria implements Serializable, Criteria {
    ...
    public TaskAuditCriteria() {}

    public TaskAuditCriteria(TaskAuditCriteria other) {
    ...
    @Override
    public TaskAuditCriteria copy() {
        return new TaskAuditCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TaskAuditCriteria that = (TaskAuditCriteria) o;
        return (
