...
/**
 * Criteria class for the {@link com.crm.domain.State} entity. This class is used
 * in {@link com.crm.web.rest.StateResource} to receive all the possible filtering options from
...
public class StateCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, code, createdAt, createdBy, updatedAt, updatedBy, active, countryId, distinct);
    }
