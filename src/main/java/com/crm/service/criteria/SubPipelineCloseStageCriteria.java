...
/**
 * Criteria class for the {@link com.crm.domain.SubPipelineCloseStage} entity. This class is used
 * in {@link com.crm.web.rest.SubPipelineCloseStageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /sub-pipeline-close-stages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SubPipelineCloseStageCriteria implements Serializable, Criteria {
    ...
    public SubPipelineCloseStageCriteria() {}

    public SubPipelineCloseStageCriteria(SubPipelineCloseStageCriteria other) {
    ...
    @Override
    public SubPipelineCloseStageCriteria copy() {
        return new SubPipelineCloseStageCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SubPipelineCloseStageCriteria that = (SubPipelineCloseStageCriteria) o;
        return (
    ...
    public String toString() {
        return "SubPipelineCloseStageCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
