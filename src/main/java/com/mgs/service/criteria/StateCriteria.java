...
/**
 * Criteria class for the {@link com.mgs.domain.State} entity. This class is used
 * in {@link com.mgs.web.rest.StateResource} to receive all the possible filtering options from
...
public class StateCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, code, countryId, distinct);
    }
