...
import com.mgs.service.TenantQueryService;
import com.mgs.service.TenantService;
...
/**
 * REST controller for managing {@link com.mgs.domain.Tenant}.
 */
@RestController
...
public class TenantResource {
    ...
    public ResponseEntity<TenantDTO> createTenant(@Valid @RequestBody TenantDTO tenantDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/tenants/" + tenantDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, tenantDTO.getId().toString()))
            .body(tenantDTO);
    }
    ...
    public ResponseEntity<TenantDTO> partialUpdateTenant(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tenantDTO.getId().toString())
        );
    }
