...
import com.mgs.service.CityQueryService;
import com.mgs.service.CityService;
import com.mgs.service.criteria.CityCriteria;
...
/**
 * REST controller for managing {@link com.mgs.domain.City}.
 */
@RestController
...
public class CityResource {
    ...
    public ResponseEntity<CityDTO> createCity(@Valid @RequestBody CityDTO cityDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/cities/" + cityDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, cityDTO.getId().toString()))
            .body(cityDTO);
    }
