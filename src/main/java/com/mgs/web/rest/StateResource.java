...
import com.mgs.service.StateQueryService;
import com.mgs.service.StateService;
import com.mgs.service.criteria.StateCriteria;
...
/**
 * REST controller for managing {@link com.mgs.domain.State}.
 */
@RestController
...
public class StateResource {
    ...
    public ResponseEntity<StateDTO> createState(@Valid @RequestBody StateDTO stateDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/states/" + stateDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, stateDTO.getId().toString()))
            .body(stateDTO);
    }
