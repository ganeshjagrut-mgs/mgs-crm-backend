...
import com.mgs.service.EventNotificationQueryService;
import com.mgs.service.EventNotificationService;
...
/**
 * REST controller for managing {@link com.mgs.domain.EventNotification}.
 */
@RestController
@RequestMapping("/api/event-notifications")
public class EventNotificationResource {
    ...
    public ResponseEntity<EventNotificationDTO> createEventNotification(@Valid @RequestBody EventNotificationDTO eventNotificationDTO)
        ...
        return ResponseEntity.created(new URI("/api/event-notifications/" + eventNotificationDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, eventNotificationDTO.getId().toString()))
    ...
    public ResponseEntity<EventNotificationDTO> updateEventNotification(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, eventNotificationDTO.getId().toString()))
            .body(eventNotificationDTO);
    }
    ...
    public ResponseEntity<EventNotificationDTO> partialUpdateEventNotification(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, eventNotificationDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<EventNotificationDTO> getEventNotification(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteEventNotification(@PathVariable("id") Long id) {
