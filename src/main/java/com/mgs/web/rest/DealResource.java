...
import com.mgs.service.DealQueryService;
import com.mgs.service.DealService;
...
/**
 * REST controller for managing {@link com.mgs.domain.Deal}.
 */
@RestController
...
public class DealResource {
    ...
    public ResponseEntity<DealDTO> createDeal(@Valid @RequestBody DealDTO dealDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/deals/" + dealDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, dealDTO.getId().toString()))
            .body(dealDTO);
    }
    ...
    public ResponseEntity<DealDTO> updateDeal(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, dealDTO.getId().toString()))
            .body(dealDTO);
    }
    ...
    public ResponseEntity<DealDTO> partialUpdateDeal(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, dealDTO.getId().toString())
        );
    }
