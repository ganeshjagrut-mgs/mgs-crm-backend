...
public class CountryAsserts {
    ...
    public static void assertCountryUpdatableFieldsEquals(Country expected, Country actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getIsoCode2()).as("check isoCode2").isEqualTo(expected.getIsoCode2()))
            .satisfies(a -> assertThat(a.getIsoCode3()).as("check isoCode3").isEqualTo(expected.getIsoCode3()))
