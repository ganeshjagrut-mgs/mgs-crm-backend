...
class TaskCommentTest {
    ...
    void createdByUserTest() {
        ...
        taskComment.setCreatedByUser(userBack);
        assertThat(taskComment.getCreatedByUser()).isEqualTo(userBack);

        taskComment.createdByUser(null);
        assertThat(taskComment.getCreatedByUser()).isNull();
    }
}
