package com.mgs.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.mgs.IntegrationTest;
import com.mgs.repository.timezone.DateTimeWrapper;
import com.mgs.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM mt_date_time_wrapper where id=%d", fieldName, id);
    }
