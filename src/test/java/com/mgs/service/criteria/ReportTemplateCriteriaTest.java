...
class ReportTemplateCriteriaTest {
    ...
    void newReportTemplateCriteriaHasAllFiltersNullTest() {
        ...
        assertThat(reportTemplateCriteria).is(criteriaFiltersAre(Objects::isNull));
    }
    ...
    void reportTemplateCriteriaFluentMethodsCreatesFiltersTest() {
        ...
        assertThat(reportTemplateCriteria).is(criteriaFiltersAre(Objects::nonNull));
    }
    ...
    private static void setAllFilters(ReportTemplateCriteria reportTemplateCriteria) {
        ...
        reportTemplateCriteria.code();
        reportTemplateCriteria.name();
        reportTemplateCriteria.description();
        reportTemplateCriteria.configJson();
        reportTemplateCriteria.isActive();
        reportTemplateCriteria.tenantId();
    ...
    private static Condition<ReportTemplateCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getConfigJson()) &&
    ...
    private static Condition<ReportTemplateCriteria> copyFiltersAre(
        ...
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getConfigJson(), copy.getConfigJson()) &&
